 ...
 */ 
	...
	{		
		...
		$statement              = $pdoLog->prepare("SELECT * FROM vResult WHERE kCut = :kCut AND cResultType != :cResultType AND cIdentifier IS NULL");
		$statement->execute(array('kCut' => $vCut['kCut'], 'cResultType' => 'global'));
	...
	<div class="container">			
			...
			<div class="panel panel-default" id="panelOptions">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-target="#collapseOptions" href="#collapseOptions">Options</a>
					</h4>
				</div>
		...
		<div class="panel-group" id="accordion">
			<div class="panel panel-default" id="panelCoordinates">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-target="#collapseCoordinates" href="#collapseCoordinates">Coordinates</a>
					</h4>
				</div>
